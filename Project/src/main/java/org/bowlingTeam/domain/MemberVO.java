...
public class MemberVO {
  ...
  */
	...
	private String mem_state; //가입신청회원 0, 가입회원 1, 탈퇴회원 2
	private String mem_grade; //관리자 0, 일반회원 1
	private String mem_joinmessage; //가입신청회원 0, 가입회원 1, 탈퇴회원 2
	...
	public String getMem_joinmessage() {
		return mem_joinmessage;
	}
	public void setMem_joinmessage(String mem_joinmessage) {
		this.mem_joinmessage = mem_joinmessage;
	}
