...
String admin_id=(String)session.getAttribute("admin_id");
     ...
     if(admin_id == null) {
    	 ...
    	 String saveFolder="D:\\bowling_site_project\\workspace\\Project\\src\\main\\webapp\\resources\\upload";
    	//이진파일 업로드 서버경로
...
String up="D:\\bowling_site_project\\workspace\\Project\\src\\main\\webapp\\resources\\upload";
