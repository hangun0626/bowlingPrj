...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">FOUR-STEP</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
        	  <ul class="navbar-nav ml-auto">
	            <li class="nav-item">
	              <a class="nav-link js-scroll-trigger" href="#about">포스텝소개1</a>
	            </li>
	            <li class="nav-item">
	              <a class="nav-link js-scroll-trigger" href="#services">포스텝회원</a>
	            </li>
	            <li class="nav-item">
	              <a class="nav-link js-scroll-trigger" href="#portfolio">공지사항</a>
	            </li>
	            <li class="nav-item">
	              <a class="nav-link js-scroll-trigger" href="#contact">SCORE관리</a>
	            </li>
	            <li class="nav-item">
	              ...
	              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">LOGIN<span class="caret"></span></a>
	                <ul class="dropdown-menu">
	                  <form method="post" action="member_login_ok" onsubmit="return login_check();">
		                  <li><input name="login_id" id="login_id" tabindex="1" size="14" placeholder="ID" required autofocus /></li>
		                  <li><input type="password" name="login_pwd" id="login_pwd" tabindex="2" id="inputPassword" size="14" placeholder="Password" required /></li>
		                  <li><input size="14" type="submit" value="로그인" /></li>
		                  <li><input type="button" value="비번찾기" onclick="pwd_find();" /></li>
				          <li><input type="button" value="회원가입" onclick="location='member_join';" /></li>
				      </form>
	                </ul>
	            </li>
		 	  </ul>
      ...
      <div class="container my-auto">
        <div class="row">
          ...
          <div class="col-lg-8 mx-auto">
            ...
            <!-- <a class="btn btn-primary btn-xl js-scroll-trigger" href="#about">점수입력 바로가기</a> -->
			 <%-- <c:if test="${empty id}">
			 로그인 전 화면
			  <div id="Login_wrap">
			   ...
			   <form method="post" action="member_login_ok" onsubmit="return login_check();">
			    <table id="Login_t">
			    <tr>
			     <input name="login_id" id="login_id" tabindex="1" class="form-control" placeholder="ID" required autofocus />
			     tabindex="1"로 설정하면 탭키를 눌렀을 때 첫번째로 포커스를 가진다.
			    </tr>
			    <tr>
			     <input type="password" name="login_pwd" id="login_pwd" tabindex="2" id="inputPassword" class="form-control" placeholder="Password" required />
			    </tr>
			    </table>
			     <input class="btn btn-lg btn-primary btn-block" type="submit" value="로그인" />
			     <input class="btn btn-lg btn-primary btn-block" type="button" value="비번찾기" onclick="pwd_find();" />
			     <input class="btn btn-lg btn-primary btn-block" type="button" value="회원가입" onclick="location='member_join';" />
			   </form>
			  </div>
			 </c:if>
			 <c:if test="${!empty id}">로그인 이후 화면
			  <div id="Index_wrap">
			   <h2 class="Index_title">로그인 : ${id}</h2>
			   <form method="post" action="member_logout">
			    <table id="Index_t">
			     <tr>
			      <input class="btn btn-lg btn-primary btn-block" type="button" value="정보수정" onclick="location='member_edit';" />
			      <input class="btn btn-lg btn-primary btn-block" type="button" value="회원탈퇴" onclick="location='member_del';" />
