...
<script src="<c:url value="/resources/js/s3Slider.js"/>"></script>
...
<body>
 <div id="wrap">
  ...
  <div id="logo">
  <a href="main">
   <img src="<c:url value="/resources/images/logo.gif"/>" width="265" height="62" alt="Fun Web" />   
  </a>
  </div>
            ...
            <div id="s3slider">
                    <ul id="s3sliderContent">
                       <li class="s3sliderImage">
                             <img src="<c:url value="/resources/images/main_img.jpg"/>" width="971" height="282">
                       ...
                       <li class="s3sliderImage">
                           <img src="<c:url value="/resources/images/main_img1.jpg"/>" width="971" height="282">
                                 <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam semper erat est. <br>
                                 Aliquam metus elit, blandit eu luctus vitae, dictum sit amet mauris. Integer ut facilisis eros. <br>
                                 Donec consectetur, velit id aliquam sagittis,</span>
                       </li>
                       <li class="s3sliderImage">
                           <img src="<c:url value="/resources/images/main_img2.jpg"/>" width="971" height="282">
                                  <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam semper erat est. <br>
                                 Aliquam metus elit, blandit eu luctus vitae, dictum sit amet mauris. Integer ut facilisis eros. <br>
                                 Donec consectetur, velit id aliquam sagittis,</span>
                       </li>                       
  ...
  html5에서 추가된 태그 --%>
   ...
   <div id="copy">
    ...
    reserved<br/>
    Contact mail : hangun0626@naver.com Tel: 010-4884-1988 
   </div>
   <div id="social">
    <img src="<c:url value="/resources/images/facebook.gif"/>" width="33" height="33" alt="Facebook" /> 
    <img src="<c:url value="/resources/images/twitter.gif"/>" width="33"  height="34" alt="Twitter" /> 
   </div>  
  </footer>
 </div>
</body>
